...
print(xtable(gender.match.table), type="latex")#setting decimal places doesn't seem to be working
```
...
stargazer(Lmodel_gender, Lmodel_age, Lmodel_location, Lmodel_details, Lmodel_all,type = "latex", report = "vcs*", single.row = T, column.labels = c("Base","Age", "Location", "Details", "All"), title ="Comparison of treatments")
#cat("\n\n\\pagebreak\n")
```
