...
```{r, echo = FALSE}
model_gender = glm(matches ~ md + bs + phd  + female + female*md + female*bs + female*phd, data = df, family = "binomial")
model_gender = glm(matches ~ md + bs + phd  + female +female*md + female*bs + female*phd , data = df, family = "binomial")
summary(model_gender)
#plot(model_MD_base, which = c(1:5))
```
...
stargazer(model_gender, model_age, model_location, model_details, model_all,type = "text", report = "vcs*", single.row = T, column.labels = c("Base","Age", "Location", "Details", "All"), title ="Comparison of treatments")
#cat("\n\n\\pagebreak\n")
```
...
#location model
model_location = glm(matches ~ md + bs + phd  + losangeles + houston + newyork + phoenix + sandiego +sanantonio +philadelphia,  data = df_female, family = "binomial")
#age
model_age = glm(matches ~ md + bs + phd  + age  , data = df_female, family = "binomial")
#details
model_details = glm(matches ~ md + bs + phd  +  school + job, data = df_female, family = "binomial")

#all
model_all = glm(matches ~ md + bs + phd  +  age + losangeles + houston + newyork + phoenix + sandiego +sanantonio +philadelphia +  school + job  , data = df_female, family = "binomial")
#Change type to "latex" for knitting to pdf
stargazer(model_gender, model_age, model_location, model_details, model_all,type = "text", report = "vcs*", single.row = T, column.labels = c("Base","Age", "Location", "Details", "All"), title ="Comparison of treatments")
#cat("\n\n\\pagebreak\n")
```
